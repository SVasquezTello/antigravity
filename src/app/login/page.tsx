      ...
      <main className="flex-1 flex flex-col justify-center items-center z-10 p-4">
        <div className="glass-card w-full max-w-md p-8 sm:p-10 animate-in fade-in zoom-in-95 duration-500">
          <h1 className="text-3xl font-bold mb-2 text-center text-white">
            <T es="Bienvenido de nuevo" en="Welcome back" />
          </h1>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div>
              <div className="flex justify-between items-center mb-1.5">
                ...
                <Link href="/forgot-password" className="text-xs text-primary hover:text-accent-pink transition-colors">
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-r from-primary to-accent-blue opacity-90 group-hover:opacity-100 transition-opacity"></div>
